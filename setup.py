...
if root_dir != '':
    os.chdir(root_dir)
extensions_dir = 'django_templatetags'
...
setup(
    ...
    long_description="""django-templatetags creates an application housing a variety of 'generic' templatetags for use on most any Django project. See the project page for more information: 
https://github.com/jbergantine/django-templatetags""",
